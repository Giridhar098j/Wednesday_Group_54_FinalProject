...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public ManageUserAccountJPanel(JPanel container, HotelEnterprise enterprise,HotelNetwork network) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Hotel Users Management");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                    ...
                                    .addGap(42, 42, 42)
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(cmbOrg, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(cmbEmp, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void cmbOrgActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbOrgActionPerformed
        ...
        if (organization != null){
            populateCmbEmp(organization);
            populateCmbRole(organization);
        }
    ...
    private void populateCmbEmp(HotelOrganization organization) {
        try {
            ...
            if (organization.getEmployeeDirectory().getHotelEmployeeList().size() > 0) {
                ...
                JOptionPane.showMessageDialog(null,"For this organization, there is no employee");
            }
        } catch (Exception e) {
                        JOptionPane.showMessageDialog(null,"Please try again");
    ...
    private void populateCmbRole(HotelOrganization organization) {
        try {
